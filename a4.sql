...
-- Teste de erro // Integridade referencial
INSERT INTO livros_autores(id_livro, id_autor) VALUES
(9, 14); /*Todos os campos "inválidos"*/
INSERT INTO livros_autores(id_livro, id_autor) VALUES
(4, 14); /*Um campo válido*/
INSERT INTO livros_autores(id_livro, id_autor) VALUES
(4, 3); /*Ambos campos válidos, mas já havia adicionado valores antes (não pode repetir)*/
INSERT INTO livros_autores(id_livro, id_autor) VALUES
(4, 1); /*Erro semântico*/
...
DELETE FROM livros WHERE id_livro = 2; /*Tenativa de deletar um livro (dá erro)*/